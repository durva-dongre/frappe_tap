...
from tap_lms.api.citizenship_academy.auth.student_auth import (
	_get_jwt_secret,
...
def _do_profile(phone, display_name, gender, grade, state, district, school_id, language, avatar, dob, migrate_student_id):
...
def create_profile(
	...
	return _do_profile(phone, display_name, gender, grade, state, district, school_id, language, avatar, dob, migrate_student_id)
