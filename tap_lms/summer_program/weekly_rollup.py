...
def calculate_week_advance_rollup(pe):
    ...
    weekly_activity_rollup = weekly_activity + weekly_submission
    weekly_total_rollup = weekly_activity_rollup + weekly_quiz + weekly_bonus_quiz
    ...
    return {
        ...
        "total_activity_points": _int_field(pe, "total_activity_points") + weekly_activity_rollup,
        ...
        "total_points": _int_field(pe, "total_points") + weekly_total_rollup,
    }
