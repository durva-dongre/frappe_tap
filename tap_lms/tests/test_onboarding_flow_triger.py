...
class TestOnboardingFlows(FrappeTestCase):
    def setUp(self):
    ...
    def tearDown(self):
        frappe.db.rollback()
        # Clean up test data
        for doctype in ["StudentStageProgress", "Backend Students", "Student", 
                       "Backend Student Onboarding", "OnboardingStage"]:
    ...
    @patch('tap_lms.onboarding_flows.get_job_status')
