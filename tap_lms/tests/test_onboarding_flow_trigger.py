...
class TestOnboardingFlowFunctions(unittest.TestCase):
    ...
    # Tests for trigger_onboarding_flow
    def test_trigger_onboarding_flow_missing_params(self):
        """Test trigger_onboarding_flow with missing parameters"""
        with patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.frappe') as mock_frappe:
            mock_frappe.throw = Mock(side_effect=Exception("Missing parameter"))
            
            from tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger import trigger_onboarding_flow
    ...
    def test_trigger_onboarding_flow_invalid_onboarding_status(self):
        """Test trigger_onboarding_flow with invalid onboarding status"""
        with patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.frappe') as mock_frappe:
            mock_stage = MagicMock()
            mock_stage.is_active = True
    ...
    def test_trigger_onboarding_flow_new_structure_success(self):
        """Test trigger_onboarding_flow with new stage_flows structure"""
        with patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.frappe') as mock_frappe:
            mock_stage = MagicMock()
            mock_stage.is_active = True
    ...
    def test_trigger_onboarding_flow_legacy_structure_success(self):
        """Test trigger_onboarding_flow with legacy structure"""
        with patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.frappe') as mock_frappe:
            mock_stage = MagicMock()
            mock_stage.is_active = True
    ...
    def test_trigger_onboarding_flow_no_flows_configured(self):
        """Test trigger_onboarding_flow with no flows configured"""
        with patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.frappe') as mock_frappe:
            mock_stage = MagicMock()
            mock_stage.is_active = True
    ...
    def test_trigger_onboarding_flow_exception_handling(self):
        """Test trigger_onboarding_flow exception handling"""
        with patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.frappe') as mock_frappe, \
             patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.traceback') as mock_traceback:
    ...
    # Tests for _trigger_onboarding_flow_job
    def test_trigger_onboarding_flow_job_group_flow(self):
        """Test _trigger_onboarding_flow_job for group flow"""
        with patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.frappe') as mock_frappe, \
             patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.get_glific_auth_headers') as mock_auth, \
             patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.trigger_group_flow') as mock_group_flow:
            ...
            from tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger import _trigger_onboarding_flow_job
    ...
    def test_trigger_onboarding_flow_job_individual_flow(self):
        """Test _trigger_onboarding_flow_job for individual flow"""
        with patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.frappe') as mock_frappe, \
             patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.get_glific_auth_headers') as mock_auth, \
             patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.trigger_individual_flows') as mock_individual_flow:
            ...
            mock_auth.return_value = {"authorization": "Bearer token"}
            mock_frappe.logger.return_value = MagicMock()
            mock_individual_flow.return_value = {"success": True}
    ...
    def test_trigger_onboarding_flow_job_auth_failure(self):
        """Test _trigger_onboarding_flow_job with auth failure"""
        with patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.frappe') as mock_frappe, \
             patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.get_glific_auth_headers') as mock_auth:
    ...
    def test_trigger_onboarding_flow_job_exception(self):
        """Test _trigger_onboarding_flow_job exception handling"""
        with patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.frappe') as mock_frappe, \
             patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.traceback') as mock_traceback:
    ...
    def test_trigger_group_flow_success(self):
        """Test trigger_group_flow success scenario"""
        with patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.frappe') as mock_frappe, \
             patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.requests') as mock_requests, \
             patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.create_or_get_glific_group_for_batch') as mock_create_group, \
             patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.get_students_from_onboarding') as mock_get_students, \
             patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.update_student_stage_progress_batch') as mock_update_batch:
            ...
            from tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger import trigger_group_flow
    ...
    def test_trigger_individual_flows_success(self):
        """Test trigger_individual_flows success scenario"""
        with patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.frappe') as mock_frappe, \
             patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.start_contact_flow') as mock_start_flow, \
             patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.time') as mock_time, \
             patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.get_students_from_onboarding') as mock_get_students, \
             patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.update_student_stage_progress') as mock_update_progress:
            ...
            from tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger import trigger_individual_flows
    ...
    def test_trigger_individual_flows_no_flow_id(self):
        """Test trigger_individual_flows with no flow ID"""
        with patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.frappe') as mock_frappe:
            mock_onboarding = MagicMock()
            mock_stage = MagicMock()
            ...
            with self.assertRaises(Exception):
                trigger_individual_flows(mock_onboarding, mock_stage, "Bearer token", self.mock_student_status, None)
    ...
    def test_get_stage_flow_statuses_new_structure(self):
        ...
        with patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.frappe') as mock_frappe:
            ...
            from tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger import get_stage_flow_statuses
    ...
    def test_get_stage_flow_statuses_no_flows(self):
        """Test get_stage_flow_statuses with no flows configured"""
        with patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.frappe') as mock_frappe:
            mock_stage = MagicMock()
            mock_stage.stage_flows = []
    ...
    def test_get_stage_flow_statuses_exception(self):
        """Test get_stage_flow_statuses exception handling"""
        with patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.frappe') as mock_frappe:
            mock_frappe.get_doc.side_effect = Exception("Database error")
            mock_frappe.log_error = Mock()
    ...
    # Tests for get_students_from_onboarding
    def test_get_students_from_onboarding_basic(self):
        """Test get_students_from_onboarding basic functionality"""
        with patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.frappe') as mock_frappe:
            mock_onboarding = MagicMock()
            mock_onboarding.name = self.mock_onboarding_set
            ...
            from tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger import get_students_from_onboarding
    ...
    def test_get_students_from_onboarding_with_stage_and_status(self):
        """Test get_students_from_onboarding with stage and status filters"""
        with patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.frappe') as mock_frappe:
            mock_onboarding = MagicMock()
            mock_onboarding.name = self.mock_onboarding_set
    ...
    def test_get_students_from_onboarding_not_started_status(self):
        """Test get_students_from_onboarding with not_started status"""
        with patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.frappe') as mock_frappe:
            mock_onboarding = MagicMock()
            mock_onboarding.name = self.mock_onboarding_set
    ...
    def test_update_student_stage_progress_new_record(self):
        """Test update_student_stage_progress creating new record"""
        with patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.frappe') as mock_frappe, \
             patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.now_datetime') as mock_now:
            ...
            from tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger import update_student_stage_progress
    ...
    def test_update_student_stage_progress_update_existing(self):
        """Test update_student_stage_progress updating existing record"""
        with patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.frappe') as mock_frappe, \
             patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.now_datetime') as mock_now:
    ...
    def test_update_student_stage_progress_no_update_completed(self):
        """Test update_student_stage_progress not updating completed record"""
        with patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.frappe') as mock_frappe, \
             patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.now_datetime') as mock_now:
    ...
    def test_update_student_stage_progress_exception(self):
        """Test update_student_stage_progress exception handling"""
        with patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.frappe') as mock_frappe, \
             patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.traceback') as mock_traceback:
    ...
    # Tests for update_student_stage_progress_batch
    def test_update_student_stage_progress_batch_success(self):
        """Test update_student_stage_progress_batch success"""
        with patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.frappe') as mock_frappe, \
             patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.now_datetime') as mock_now:
            ...
            from tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger import update_student_stage_progress_batch
    ...
    def test_update_student_stage_progress_batch_exception(self):
        """Test update_student_stage_progress_batch exception handling"""
        with patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.frappe') as mock_frappe, \
             patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.traceback') as mock_traceback:
    ...
    def test_get_job_status_no_job_id(self):
        """Test get_job_status with no job ID"""
        from tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger import get_job_status
    ...
    def test_get_job_status_failed(self):
        """Test get_job_status with failed job"""
        with patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.frappe') as mock_frappe, \
             patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.get_job_status') as mock_job_status_func:
    ...
    def test_get_job_status_finished_with_results(self):
        """Test get_job_status with finished job and results"""
        with patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.frappe') as mock_frappe, \
             patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.get_job_status') as mock_job_status_func, \
             patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.Job') as mock_job_class, \
             patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.get_redis_conn') as mock_redis:
    ...
    def test_get_job_status_finished_no_results(self):
        """Test get_job_status with finished job but no results"""
        with patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.frappe') as mock_frappe, \
             patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.get_job_status') as mock_job_status_func, \
             patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.get_redis_conn') as mock_redis:
    ...
    def test_get_job_status_exception(self):
        ...
        with patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.frappe') as mock_frappe, \
             patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.traceback') as mock_traceback, \
             patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.get_job_status', side_effect=Exception("Error")):
    ...
    # Tests for get_onboarding_progress_report
    def test_get_onboarding_progress_report_basic(self):
        """Test get_onboarding_progress_report basic functionality"""
        with patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.frappe') as mock_frappe:
            progress_records = [
                {
            ...
            from tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger import get_onboarding_progress_report
    ...
    def test_get_onboarding_progress_report_not_started_students(self):
        """Test get_onboarding_progress_report including not_started students"""
        with patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.frappe') as mock_frappe:
            # Mock progress records (empty)
            progress_records = []
    ...
    def test_get_onboarding_progress_report_exception(self):
        """Test get_onboarding_progress_report exception handling"""
        with patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.frappe') as mock_frappe, \
             patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.traceback') as mock_traceback:
    ...
    def test_update_incomplete_stages_success(self):
        ...
        with patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.frappe') as mock_frappe, \
             patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.now_datetime') as mock_now, \
             patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.add_to_date') as mock_add_to_date:
            ...
            from tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger import update_incomplete_stages
    ...
    def test_update_incomplete_stages_exception(self):
        """Test update_incomplete_stages exception handling"""
        with patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.frappe') as mock_frappe, \
             patch('tap_lms.tap_lms.page.onboarding_flow_trigger.onboarding_flow_trigger.traceback') as mock_traceback:
